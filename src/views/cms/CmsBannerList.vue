...
<!--          </a-col>-->
    ...
    <cms-banner-modal ref="modalForm" @ok="modalFormOk"></cms-banner-modal>
  </a-card>
</template>
...
<script>
  ...
  import CmsBannerModal from './modules/CmsBannerModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/cms/manager/cmsBanner/list",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'series',text:'轮播图编组',dictCode:''})
        fieldList.push({type:'int',value:'type',text:'类型',dictCode:''})
        fieldList.push({type:'string',value:'url',text:'跳转的url',dictCode:''})
        fieldList.push({type:'string',value:'parm',text:'参数',dictCode:''})
        fieldList.push({type:'string',value:'img',text:'图片地址',dictCode:''})
